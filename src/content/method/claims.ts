...
export const METHOD_REVERSALS: MethodReversal[] = [
  ...
  {
    /*
     * THE THIRD REVERSAL (2026-09-23, owner rulings BA-3 / BA-6 / BA-7 / BA-10).
     * It reverses the second within the day, and moves the flagship. Its own
     * entry, for the reason the second gives: a reversal is a record, and
     * editing the second would erase the hours in which the snack was back.
     */
    id: "reversal-snack-retired-reading-flagship",
    what: "The snack retired again, and the reading made the product",
    rule: "D1 and D3 — the product describes what you did, and the Prestige Test was the flagship",
    kind: "quoted",
    reversal:
    ...
    sources: [
      {
        ...
        anchor: "**The snack is retired.** Its questions ask people to describe their own taste",
      },
      {
        path: "docs/rt-answers-2026-09-23-audit.md",
        anchor: "D3 is amended: the flagship is the reading, not the Prestige Test",
      },
      {
        path: "docs/rt-answers-2026-09-23-audit.md",
        anchor: "No surface may assert a feeling",
      },
    ],
  },
];
