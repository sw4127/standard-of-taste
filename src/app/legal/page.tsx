    ...
    <main className={SHELL_MAIN}>
      ...
      <section className="mt-8">
        ...
        <p className="mt-2 text-sm leading-relaxed text-slate-300">
          ...
          personality, your mood or your character, and never claim to. One surface may speak to
          you about yourself — the prompt card. It offers a reading rather than asserting one, and
          it says nothing about trauma, abuse or mental health.
        </p>
      </section>
