    ...
    <main className={SHELL_MAIN}>
      ...
      <section className="mt-8">
        ...
        <p className="mt-2 text-sm leading-relaxed text-slate-300">
          ...
          you about yourself — the prompt card and the reading. Both offer a reading rather than
          asserting one, and neither says anything about trauma, abuse or mental health. The
          reading runs on illustrative listeners: the plays it reads are generated, not yours.
        </p>
      </section>
      ...
      */}
      <section className="mt-7">
        ...
        <ul className="mt-2 flex list-disc flex-col gap-2 pl-5 text-sm leading-relaxed text-slate-300">
          ...
          <li>
            No sentence on this site is generated by a language model when you visit, and nothing
            you do here is sent to one. Every sentence is a fixed template and every result is
