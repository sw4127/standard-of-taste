...
- **Part 5 · The reading, the front door and the Company view** — Everything the blueprint build added (2026-09-23): the reading and its lines, the front door, the nav and the Company view. None of it has had a writing pass. The blueprint statements at the end are printed and locked.
...
> ${pct > 0 ? "+" : ""}${pct}% toward the names
  ...
  *As rendered:* “-31% toward the names”  ·  “+31% toward the names”  · …and 3 between them

**Every reachable shape** (renderings of the sentence above, not separate strings):

```renders
pct = -31 → -31% toward the names
pct =  -1 → -1% toward the names
pct =   0 → 0% toward the names
pct =   1 → +1% toward the names
pct =  31 → +31% toward the names
```
...
```renders
1 of 1 → Catching is one skill and naming is another. Of the pairs you caught, you named the flaw 1 of 1 time.
3 of 5 → Catching is one skill and naming is another. Of the pairs you caught, you named the flaw 3 of 5 times.
5 of 8 → Catching is one skill and naming is another. Of the pairs you caught, you named the flaw 5 of 8 times.
0 of 4 → Catching is one skill and naming is another. Of the pairs you caught, you named the flaw 0 of 4 times.
```
...
`INS-THRESHOLD-COOLDOWN-01` · OPEN
...
`INS-THRESHOLD-COOLDOWN-02` · OPEN
...
`INS-THRESHOLD-COOLDOWN-03` · OPEN
...
**Edits land in** `src/app/learn/why/page.tsx`.

> THE READING · THE ARGUMENT

`PAGE-LEARN-WHY-01` · OPEN
> The argument. Each step is labelled with what supports it: evidence, an assumption, or an inference from the steps before.

`PAGE-LEARN-WHY-02` · OPEN
> Three things common sense says, and the project rejects.

`PAGE-LEARN-WHY-03` · OPEN
> The bridge. Why the reading ends where the hearing tests begin.
...
`PAGE-LEGAL-02` · OPEN
> Standard of Taste measures how you hear music. Each instrument is a listening task with answers you can get objectively wrong, and every number is computed by a deterministic engine in code — no machine-learning model and no language model classifies you. It is not a psychological assessment, not a personality test, not medical or mental-health advice, and not a diagnosis of anything. The instruments in the gym do not predict your personality, your mood or your character, and never claim to. Two surfaces may speak to you about yourself — the prompt card and the reading. Both offer a reading rather than asserting one, and neither says anything about trauma, abuse or mental health. The reading runs on illustrative listeners: the plays it reads are generated, not yours.
...
`MET-SEVEN-REFUSALS-01` · PART-LOCKED
...
`MET-SEVEN-REFUSALS-02` · PART-LOCKED
...
`MET-SEVEN-REFUSALS-03` · PART-LOCKED
...
`MET-SEVEN-REFUSALS-04` · PART-LOCKED
...
`MET-SEVEN-REFUSALS-05` · PART-LOCKED
...
`MET-SEVEN-REFUSALS-06` · PART-LOCKED
...
`MET-SEVEN-REFUSALS-07` · PART-LOCKED
...
`MET-SEVEN-REFUSALS-08` · PART-LOCKED
...
`MET-SEVEN-REFUSALS-09` · PART-LOCKED
...
`MET-SEVEN-REFUSALS-10` · PART-LOCKED
...
`MET-SEVEN-REFUSALS-11` · PART-LOCKED
...
`MET-SEVEN-REFUSALS-12` · PART-LOCKED
...
`MET-SEVEN-REFUSALS-13` · PART-LOCKED
...
`MET-SEVEN-REFUSALS-14` · PART-LOCKED
...
# Part 5 · The reading, the front door and the Company view

*Also written to `docs/copy-deck-reading.md` by this same command.*
...
`READ-FRONT-DOOR-01` · OPEN
> Your last month of listening holds a pattern you have probably never put into words.

*`LANDING_READING_TURN`:*

`READ-FRONT-DOOR-02` · OPEN
> Here it is read back to you, line by line, with the plays behind each line: keep what fits, reject what doesn't, and carry what is left into a prompt.
...
`READ-FRONT-DOOR-03` · OPEN
> Then find out which of those words you can actually hear.
...
`READ-SHARED-NAVIGATION-01` · OPEN
> THE READING · HEARING · THE COMPANY VIEW · READING ROOM · THE LAB · THE METHOD
...
> Each is four weeks of plays by someone who does not exist. Read one as if the plays were yours. Every line below is computed from those plays, and every line shows the plays it counted.
...
> Rejected. It is out of your prompt.
...
`READ-LINES-THREE-09` · another rendering of the same template — edit it once, above
...
`READ-LINES-THREE-10` · another rendering of the same template — edit it once, above
> 18 of 88 plays in week one; 44 of 98 in week four

`READ-LINES-THREE-11` · another rendering of the same template — edit it once, above
> Is music built on chopped vocal samples and bright synths somewhere you are heading?

*prompt words: arriving, turning, new-found*

`READ-LINES-THREE-12` · another rendering of the same template — edit it once, above
> Or was music built on live bass and brushed drums something you needed then, and need less now?

*prompt words: after, lighter, moving on*

`READ-LINES-THREE-13` · another rendering of the same template — edit it once, above
> Arc: starts near live bass and brushed drums and ends on chopped vocal samples and bright synths

*newShare:*

`READ-LINES-THREE-25` · OPEN
...
`READ-LINES-THREE-11` · another rendering of the same template — edit it once, above
> Is music built on fingerpicked nylon guitar somewhere you are heading?

*prompt words: arriving, turning, new-found*

`READ-LINES-THREE-12` · another rendering of the same template — edit it once, above
> Or was music built on distorted guitars in a wall of sound something you needed then, and need less now?
...
`READ-LINES-THREE-01` · another rendering of the same template — edit it once, above
> 82% of your plays were tracks you already knew before these four weeks began.

> 206 of 251 plays

`READ-LINES-THREE-02` · another rendering of the same template — edit it once, above
> Is what you already know doing the job right now?

*prompt words: familiar, trusted, worn-in*

`READ-LINES-THREE-03` · another rendering of the same template — edit it once, above
> Or is there no room at the moment for anything new?

*prompt words: full, close, sheltered*

`READ-LINES-THREE-04` · another rendering of the same template — edit it once, above
> Familiarity: familiar shapes, nothing that surprises

*repetition:*

`READ-LINES-THREE-05` · another rendering of the same template — edit it once, above
> Three tracks took 43% of your 251 plays: Fennow Letter, Tamsel Lullaby and Cindergrist.

> 108 of 251 plays

`READ-LINES-THREE-06` · another rendering of the same template — edit it once, above
> Are these holding something in place, so nothing new has to be chosen?

*prompt words: steady, circling, familiar*

`READ-LINES-THREE-07` · another rendering of the same template — edit it once, above
> Or are you still inside them, listening for something you have not found yet?

*prompt words: searching, returning, close*

`READ-LINES-THREE-08` · another rendering of the same template — edit it once, above
> Form: a loop that circles back, made to be replayed
...
`READ-COMPANY-VIEW-07` · OPEN
> Tessavox already holds what the reading needs: every listener's recent plays. Nobody is asked to describe their taste, which the blueprint holds almost nobody can do (BP-CA2).

`READ-COMPANY-VIEW-08` · OPEN
...
`READ-COMPANY-VIEW-18` · OPEN
> For each line template, rejections over showings.

`READ-COMPANY-VIEW-19` · OPEN
> High means the template is wrong. Near zero is its own warning: a line nobody ever rejects may be true of everyone, which is the Barnum effect the receipts exist to prevent (BP-ARG-OBJECTION).

> Carve-out hits

`READ-COMPANY-VIEW-20` · OPEN
> Rendered sentences that match the carve-out patterns.

`READ-COMPANY-VIEW-21` · OPEN
> The target is zero, always: nothing on any surface asserts anything about trauma, abuse or mental health.

> Opt-out rate

`READ-COMPANY-VIEW-22` · OPEN
> Listeners who turn the reading off, over listeners shown it.

`READ-COMPANY-VIEW-23` · OPEN
...
`READ-COMPANY-VIEW-24` · OPEN
> Doesn't the recommender already do this?

`READ-COMPANY-VIEW-25` · OPEN
...
`READ-COMPANY-VIEW-32` · OPEN
> Will labels see this as a tool that competes with their artists?

`READ-COMPANY-VIEW-33` · OPEN
> The prompt feeds Tessavox's licensed tool, which is the direction the industry has taken in public: a streaming service building AI music products with the labels rather than around them.

`READ-COMPANY-VIEW-34` · OPEN
> Creation starts per visitor at the creation entry, with the plain prompt box: 20%

`READ-COMPANY-VIEW-35` · OPEN
...
**354 sentences, each with an id.** 18 further lines are additional RENDERINGS of sentences already listed — they carry the id they belong to and are not separate strings to edit. Which surfaces have ever been through a writer is in `docs/copy-review-ledger.md`.
