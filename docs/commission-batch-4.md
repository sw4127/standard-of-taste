...
> prefix. 40 ids: 4 OPEN and 36 PART-LOCKED.** It is one page: the published account of how this
...
- **Part 4 is 40 of 40 source templates**, measured by `scripts/deck-source-trace.mjs`. A day ago it
